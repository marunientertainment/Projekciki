...
namespace Zwój_Opowieści_2
{
    ...
    {
        public Swamps S1 = new Swamps("Bagna1", "Śmierdzące bagna z potworami.", 10, false);
        public Swamps S2 = new Swamps("Bagna2", "Śmierdzące bagna z trudniejszymi potworami.", 10, true);
        public Left_Vilages LV1 = new Left_Vilages("Opiszczona wioska 1", "Kiedyś ktoś tu żył ale teraz są tu tylko nie umarli.", 10, false);
        public Left_Vilages LV2 = new Left_Vilages("Opiszczona wioska 2", "Kiedyś ktoś tu żył ale teraz są tu tylko nie umarli i troche koztowności.", 10, true);
        public Chambers C1 = new Chambers("Komnaty 1", "W tych komnatach jest troche złota i potwory.", 10, false);
        public Chambers C2 = new Chambers("Komnaty 2", "W tych komnatach jest dużo złota i jeszcze wiecej podworów.", 10, true);
        public Black_Castle B1 = new Black_Castle("Czarny Zamek 1", "Swąt śmierci przelpata sie z zapachem pieniędzy.", 10, false);
        public Black_Castle B2 = new Black_Castle("Czarny Zamek 2", "Świetne miejsce na zarobek, okropne by umrzeć.", 10, true);
